...
import 'view.dart';
// import 'empdaily.dart';
import '../pages/easy.dart'; // Adjust the path based on your folder structure
...
class _AdminPanelState extends State<AdminPanel> {
  ...
  void _navigateToEasyPage() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => const EasyPage()),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Admin Panel', style: AdminStyle.headingMedium),
        centerTitle: true,
        actions: [
          // IconButton(
                  ...
                  Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // 5. Replace the Job Position dropdown with a simple TextField:
                        TextFormField(
                        ...
                        // DropdownButtonFormField<String>(
                        //   initialValue: _jobPositionController.text.isEmpty
                        //       ? null
                        ...
                        //     });
                        //   },
                        //   validator: _validateJobPosition,
                        // ),
                        // const SizedBox(height: AdminStyle.spacingL),

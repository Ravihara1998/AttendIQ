...
class _SuperviewState extends State<Superview> {
      ...
      if (mounted) {
        setState(() {
          ...
          if (companies.isNotEmpty) {
            ...
            // Don't call _loadEmployees here, do it after setState completes
          }
        });

        // Load employees after state is updated
  ...
  Future<void> _loadEmployees() async {
    ...
    try {
      ...
      // Filter employees by selected company (case insensitive)
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _isLoadingCompanies
          ...
          : Column(
              children: [
                // Company Selector Dropdown - ADD THIS SECTION:
                Container(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: ViewStyle.primaryColor.withOpacity(0.3),
                        width: 1.5,
                      ),
                      boxShadow: [
                        BoxShadow(
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton<String>(
                        ...
                        dropdownColor: ViewStyle.surfaceColor,
                            ...
                            child: Row(
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: ViewStyle.primaryColor.withOpacity(
                                      0.1,
                                    ),
                ...
                // Employee Count with Company Name
                Padding(
